...
func (self *ZeroCopySink) WriteUint160(addr Uint160) {
	self.WriteBytes(addr[:])
}

func (self *ZeroCopySink) WriteFixed64(f Fixed64) {
	self.WriteInt64(int64(f))
}

func (self *ZeroCopySink) WriteUint256(hash Uint256) {
